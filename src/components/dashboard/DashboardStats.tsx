...
import { EditTotalIncomeModal } from '../modals/EditTotalIncomeModal';
...
export const DashboardStats: React.FC = () => {
  ...
  const [showEditTotalIncomeModal, setShowEditTotalIncomeModal] = useState(false);
  ...
  const handleTotalIncomeClick = (e: React.MouseEvent) => {
    e.preventDefault();
    setShowEditTotalIncomeModal(true);
  };
    ...
    <>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div 
          ...
          onContextMenu={handleTotalIncomeClick}
        >
          <div className="flex items-center">
      ...
      <EditTotalIncomeModal
        isOpen={showEditTotalIncomeModal}
        onClose={() => setShowEditTotalIncomeModal(false)}
      />
    </>
  );
};